    ...
    return (
      <Formik
        ...
        validate={values => {
          ...
          } else if (posX > this.props.maxX) {
            errors.posX = "X placement outside bounds of grid";
          }
          if (posY !== 0 && !posY) {
            errors.posY = "Required";
          } else if (!/^[0-9]+$/.test(posY)) {
            errors.posY = "Please only use numbers";
          } else if (posY > this.props.maxY) {
            errors.posY = "Y placement outside bounds of grid";
          }
          return errors;
        }}
      >
